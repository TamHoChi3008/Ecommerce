            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">GREEN Admin</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="color: #55a54a;">Login to Your Account</h5>
                    <p class="text-center small">Enter your username & password to login</p>
                  </div>

                  <form class="row g-3 needs-validation"
                  action="/handle-login-admin" method="post">
              @csrf
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Username</label>
                      <div class="input-group has-validation" >
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" name="admin_email" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit"name="login" style="background-color: #66f585;">Login</button>
                    </div>
                    <div class="col-12">
